...
def parse_opt():
    ...
    parser.add_argument('--num_layers', type=int, default=11, help='11.')
    parser.add_argument('--m_dim', type=int, default=256, help='256.')
    ...
    parser.add_argument('--load_DBIM', type=bool, default=True, help='Computation device.')
    parser.add_argument('--DBIM_path', type=str, default='saved_model/DBIM_model_gamma_3.pth',
                        help='Computation device.')
    parser.add_argument('--load_PaiNN', type=bool, default=true, help='Computation device.')
